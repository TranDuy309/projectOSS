						...
						<div class="wizard-content">
							<form class="tab-wizard2 wizard-circle wizard">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select class="form-control selectpicker" title="Chọn Chức Vụ">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">Mức độ</label>
											<div class="col-sm-8">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">CCCD/CMND</label>
											<div class="col-sm-3">
												<input type="text" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<div class="row">
													<div class="col-6">
														<select class="form-control selectpicker" title="Tháng" data-size="5">
													...
													<div class="col-6">
														<select class="form-control selectpicker" title="Năm" data-size="5">
															<option>2020</option>
															<option>2019</option>
															<option>2018</option>
															<option>2017</option>
