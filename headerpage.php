			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name">Frog Crying</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="profile.php"><i class="dw dw-user1"></i> Chi tiết</a>
						<a class="dropdown-item" href="profile.php"><i class="dw dw-settings2"></i> Cài đặt</a>
						<a class="dropdown-item" href="faq.php"><i class="dw dw-help"></i>Trợ giúp</a>
